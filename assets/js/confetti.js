let maxParticleCount = 250, //set max confetti count
	particleSpeed = 1, //set the particle animation speed
...
(function () {
	...
	function startConfettiInner() {
		...
		if (canvas === null) {
			...
			canvas.setAttribute('style', 'display:block;z-index:999999;pointer-events:none;margin-top: -600px;');
